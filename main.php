    ...
    <div class="container">
        ...
        <div class="center">
          ...
          <form method='post' action='addpatient.php' onsubmit='return true'>                       
                ...
                <button type="submit" class="btn btn-outline-success ">View Room Information</button>     
                </form>
            ...
            ?>
              ...
              <tr>
                ...
                <td class="btnCol">
                  ...
                  <button id="testBtn" name="patientID" value="<?php echo "$row[patientID]" ?>" class="btn btn-outline-success">Tests</button>
                ...
                <td class="btnCol">
                  ...
                  <button id="treatmentBtn" name="patientID" value="<?php echo "$row[patientID]" ?>" class="btn btn-outline-success">Treatments</button>
                ...
                <td class="btnCol">
                  ...
                  <button id="prescriptionBtn" name="patientID" value="<?php echo "$row[patientID]" ?>" class="btn btn-outline-success">Prescriptions</button>
